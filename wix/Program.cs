...
namespace wix
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            st.WriteLine(@"move F:\OneDriveFolder\OneDrive\###SahredFiles\Soleon\MissionPlanner*.* F:\OneDriveFolder\OneDrive\###SahredFiles\Soleon\Older-Versions\");
            st.WriteLine(@"move " + fn + @".* F:\OneDriveFolder\OneDrive\###SahredFiles\Soleon\");
