...
namespace racPlayerControl
{
    public partial class racPlayerControl : UserControl
    {
        string url_string = "";
...
/*
        ...
        */
        ...
        private void toolStripButton4_Click(object sender, EventArgs e)
        {
            ...
            else { StopRecording(); tsbRecording.Image = Resources.record_512; blink_timer.Enabled = false; }
        }
        ...
        {
            if (tick)
            { tsbRecording.Image = Resources.record_5121; tick = false; }
            else { tsbRecording.Image = Resources.record_512; tick = true; }
        }
