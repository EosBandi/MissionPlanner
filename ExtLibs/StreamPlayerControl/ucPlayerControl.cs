...
namespace Player
{
    public partial class ucPlayerControl : UserControl
    {
        ...
        private void StreamPlayerControl1_StreamFailed(object sender, WebEye.StreamFailedEventArgs e)
        {
        ...
        public void StartRecording()
        {
            ...
            if (ffmpeg_params == "")
            {
                ffmpeg_params = rtsp_param + " -i " + url_string + " -f segment -segment_time 1800 -segment_format mp4 -reset_timestamps 1 -c copy -map 0 -strftime 1 " + record_path + "rec_%Y%m%d_%H%M%S.mp4 ";
            }
        ...
        public void StartRecording(string path, string prefix, bool fragmented=true, int fragmenttime = 1800, string filetype="mp4")
        {
            string param = "";
        ...
        private void toolStripButton4_Click(object sender, EventArgs e)
        {
            ...
            else { StopRecording(); tsbRecording.Image = WebEye.Properties.Resources.record_512; blink_timer.Enabled = false; }
        }
        ...
        {
            if (tick)
            { tsbRecording.Image = WebEye.Properties.Resources.record_5121; tick = false; }
            else { tsbRecording.Image = WebEye.Properties.Resources.record_512; tick = true; }
        }

        public void szinAllitasPlayer(Color e, Color f, Color g)
        {
            this.streamPlayerControl1.BackColor = f;
            this.playmenu.BackColor = g;
            this.status.BackColor = g;
