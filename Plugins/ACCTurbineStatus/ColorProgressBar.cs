...
namespace ACCTurbineStatus
{
    public partial class ColorProgressBar : MyUserControl
    {
        //
        // Summary:
        ...
        internal Color _OutlineColor = Color.FromArgb(31, 54, 8);
        internal Color _Outline = Color.FromArgb(150, 171, 112);
        internal bool _drawlabel = true;
        ...
        public  string Label { get => m_Text; set { m_Text = value; Invalidate(); } }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            LinearGradientBrush linear = new LinearGradientBrush(outside, Color.Red, Color.Yellow, LinearGradientMode.Horizontal);
            ColorBlend cblend = new ColorBlend(3);
            cblend.Colors = new Color[3] { Color.Red, Color.Yellow, Color.Green };
            cblend.Positions = new float[3] { 0f, 0.5f, 1f };

            linear.InterpolationColors = cblend;
        ...
        private void drawlbl(Graphics e)
        {
            if (DrawLabel)
            {
                ...
                p.AddString((m_Text).Trim(), this.Font.FontFamily, (int)this.Font.Style, this.Font.Size, rect, drawFormat);
                e.DrawPath(new Pen(_OutlineColor), p);
                e.FillPath(new SolidBrush(TextColor), p);
