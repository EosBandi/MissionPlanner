    ...
    public partial class FlightPlanner : MyUserControl, IDeactivate, IActivate
    {
        ...
        private Locationwp DataViewtoLocationwp(int a)
        {
            try
            {
                ...
                temp.dist = Convert.ToDouble(Commands.Rows[a].Cells[Dist.Index].Value);
                temp.Az = Convert.ToDouble(Commands.Rows[a].Cells[AZ.Index].Value);
        ...
        /// </summary>
        private void processToScreen(List<Locationwp> cmds, bool append = false, bool removehome = true)
        {
            quickadd = true;
            ...
            if (!append && type == MAVLink.MAV_MISSION_TYPE.MISSION)
            {
                ...
                if ((Commands.RowCount > 0) && removehome)
                {
...
Column 1: Field type (RALLY is the only one at the moment -- may have RALLY_LAND in the future)
 ...
 Column 7: Flags (just 0 for now, also future use).
        ...
        private void bUpdateFormation_Click(object sender, EventArgs e)
        {
